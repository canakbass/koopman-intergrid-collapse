...
def main(a):
    ...
    for it in range(a.iters):
        if a.dmd == "partial" and it == a.dmd_at:   # yalnızca [1.5,4] rad/s bandındaki tek temel mod kilitlenir
    ...
    rec = dict(task="pendulum", model=a.model, dmd=a.dmd, sampling=a.sampling, seed=a.seed, **info, learned_omegas=model.omega.detach().cpu().tolist(),
...
if __name__ == "__main__":
    ...
    p.add_argument("--model", default="koop"); p.add_argument("--dmd", default="none", choices=["none", "lock", "ft", "harm", "mr", "partial"])
