...
def main(a):
    ...
    for it in range(a.iters):
        if a.dmd == "mr" and it == a.dmd_at:     # çok hızlı DMD: Δt1 + Δt2 spektrumlarından tekil ω kaldırma
...
if __name__ == "__main__":
    ...
    p.add_argument("--dmd", default="none", choices=["none", "lock", "ft", "harm", "mr"]); p.add_argument("--dmd_at", type=int, default=500)
